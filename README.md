# BarAnimation
iOS - 振幅动画
产品需求中有一个按钮, 当音乐播放的时候 是跳动的 , 所以简单的写了一个demo, 如下效果, 具体看demo github  https://github.com/zhaoweizheng/BarAnimation.git  如果对你有帮助,请star一下
![这里写图片描述](http://img.blog.csdn.net/20161118102443177)
